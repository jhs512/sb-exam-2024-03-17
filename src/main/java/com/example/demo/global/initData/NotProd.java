...
public class NotProd {
    ...
    public void work1() {
        ...
        chatService.writeMessage(room1, "user2", "message2");
        chatService.writeMessage(room1, "user3", "message3");
        chatService.writeMessage(room2, "user1", "message4");
        chatService.writeMessage(room2, "user2", "message5");
        chatService.writeMessage(room3, "user1", "message6");
    }
}
